...
We define functions in a way to avoid all of the shortcomings present in the relations defined in Example 6.1.1 and Example 6.1.2. Before we give the definition though, we intruduce one more quantifier.
...
Consider the funcion $f: \{1, 2, 3, 4\} \rightarrow \{a, b, c, d\}$ where 
...
The function $g: A \rightarrow B$ is called the **extesion** of $f$ to $A$ if (and only if) 
