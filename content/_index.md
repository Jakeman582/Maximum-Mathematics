...
description = 'Mathematics textbooks, problem sets, and the Maximum Mathematics Asymptote library.'
type = 'home'
+++
...
with [the Maximum Mathematics Asymptote library]({{% relref "/asymptote" %}}),
free to use in your own work — its full documentation lives on
[its own site](https://jakeman582.github.io/Maximum-Asymptote/).

{{% notice style="primary" title="Under construction" %}}
